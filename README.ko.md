...
- positive/class condition의 `orShould()`(bounded negative `noFields()`/`noMethods()` condition tree는 지원) 또는 custom, dynamic, helper-backed, unresolved leaf가 하나라도 포함된 boolean tree
